...
Hematopoietic stem cells (HSCs) sit at the apex of the differentiation hierarchy, marked by their capacity for both self-renewal and differentiation into all blood lineages. Efforts are ongoing to enhance HSC engraftment as a therapeutic strategy to treat patients suffering from hematopoietic diseases. The identification of genes expressed specifically in HSCs may help improve methods of stem cell isolation. In this study, we investigate Multimerin-1 (Mmrn1) as a potential novel marker of Long-term hematopoietic stem cells (LT-HSCs) through analysis of single cell RNA sequencing data collected by Nesterowa et al., complemented by quantitative PCR (qPCR). Analysis of over 1600 single HSPC transcriptomes revealed the differential expression between specific cell populations, indicating a change in the transcriptional landscape during haematopoiesis. This also revealed Mmrn1 to be distinctly upregulated in LT-HSCs compared to other progenitor populations. We attempted to validate these findings by qPCR, confirming high expression in the LT-HSC and MPP population of cells. These findings indicate Mmrn1 may have significant implications for improving HSC purification protocols and enhancing transplantation outcomes. Additionally, previous findings have reported Mmrn1 upregulation in many cancers and association with Leukaemia stem cells. We propose Mmrn1, known for its adhesive functions and extensive role in the extracellular matrix (ECM), may have a role in the bone marrow matrix for sustaining Long term repopulating cells. The insights from this study not only propose a novel marker for stem cell biology but also contribute to the understanding of cellular dynamics within the bone marrow micro-environment.
...
All computational analysis was performed in the R programming environment ([https://www.r-project.org](https://www.r-project.org/)). we took RNA-seq data are from an Illumina machine 150-300bp; Metagenomic data are often Nanopore 10,000 - 30000bp. The raw data was exctracted as Reads in FASTQ files, containing the sequence and a quality score for each base. The reads were filtered and trimmed on the basis of the quality score then aligned to a reference genome/transcriptome. The expression of genes was quantified by the count of reads. The counts were normalised to account for differences in sequencing depth and gene/transcript/genome length before statistical analysis[@rand2023. The dataset was then filtered for cell surface genes [@bausch-fluck2015].

Values are presented as means ± SEM. Statistical significance was determined by one-way ANOVA for overall expression differences of a *Mmrn1* across the multiple Cell Types. With subsequent pairwise comparisons facilitated through Tukey's Honest Significant Difference (HSD) test to identify specific differences between groups.  For direct comparison between two genes, unpaired students t-tests were utilised. P-values \< 0.05 were considered significant and shown in each figure.
